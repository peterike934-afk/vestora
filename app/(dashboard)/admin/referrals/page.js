...
const s = {
  page: { padding: '32px 36px', maxWidth: '100vw', boxSizing: 'border-box' },
  title: { fontSize: '26px', fontWeight: '700', color: 'var(--text)', marginBottom: '4px' },
  sub: { fontSize: '14px', color: 'var(--text2)', marginBottom: '28px' },
  card: { background: 'var(--bg2)', border: '1px solid var(--border)', borderRadius: 'var(--radius)', padding: '24px', maxWidth: '100%', boxSizing: 'border-box' },
  tableWrap: { overflowX: 'auto', WebkitOverflowScrolling: 'touch' },
  th: { fontSize: '11px', fontWeight: '500', color: 'var(--text3)', letterSpacing: '0.06em', textTransform: 'uppercase', padding: '0 8px 12px 0', textAlign: 'left', whiteSpace: 'nowrap' },
  td: { padding: '12px 8px 12px 0', borderTop: '1px solid var(--border)', fontSize: '13px', color: 'var(--text)', whiteSpace: 'nowrap' },
